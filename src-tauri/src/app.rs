...
use crate::renderer::CellState::{self, Alive, Dead};
use crate::renderer::{RenderState, StateGrid, clear_screen, init_render_state, render_screen};

const GRID_WIDTH: u32 = 128;
const GRID_HEIGHT: u32 = 72;
const CELL_SIZE: u32 = 10;

fn setup_renderer<R: tauri::Runtime>( // WPU initialization and render thread creation
    app: &mut App<R>,
